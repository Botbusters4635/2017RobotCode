...
//Maybe works?
path EctoPath::smoother(path pathIn, double weight_data, double weight_smooth,double tolerance){
	path newPath = pathIn;
...
path EctoPath::velocityFix(path smoothVelocity, path origVelocity, double tolerance){
...
vector<int> EctoPath::injectionCounter2Steps(double numNodeOnlyPoints, double maxTimeToComplete, double timeStep){
	int first = 0;
	int second = 0;
	int third = 0;
...
void EctoPath::calculate(double totalTime, double timeStep, double robotTrackWidth){
